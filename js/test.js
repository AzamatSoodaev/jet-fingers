...
function count_down() {
  	...
  	if(countdown > 9)
	{
		...
		var send_data = "sz="+start_time+"&ez="+end_time+"&wordlist="+$("#wordlist").text()+"&user_input="+ encodeURIComponent(user_input_stream)+"&backspace_counter="+correction_counter+"&afk_timer="+afk_timer+"&speedtest_id="+$("#speedtest-id").attr("value")+"&mode="+$("#speedtest_mode").attr("value");
